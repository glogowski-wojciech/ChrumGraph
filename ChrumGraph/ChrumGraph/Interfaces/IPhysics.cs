...
namespace ChrumGraph
{
    ...
    public interface IPhysics
    {
        ...
        /// <summary>
        /// Starts IPhysics simulation. Can be stopped with StopSimulation method.
        /// </summary>
        /// <param name="fps">Frequency of IPhysics iterations per second.</param>
        void StartSimulation(double fps);

        /// <summary>
        /// Starts IPhysics simulation. Stops after ms miliseconds.
        /// </summary>
        /// <param name="ms">Time of IPhysics simulation in miliseconds.</param>
        void StartSimulation(int ms);

        /// <summary>
        /// Stops simulation started with StartSimulation. If IPhysics simulation is not working, does nothing.
        /// </summary>
        void StopSimulation();
    }
}
